...
function limparFormatacao(texto) {
  return texto
    ...
    .replace(/^[-*]\s+/gm, '— ')        // listas com - ou * → travessão
    .trim();
}
...
- NUNCA uses Markdown: sem **negrito**, sem ### títulos, sem listas com * ou -.
...
- Para destacar um termo importante, usa apenas a palavra em maiúsculas ocasionalmente, nunca símbolos de formatação.
